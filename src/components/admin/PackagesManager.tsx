                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="space-y-1 flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground flex-wrap">
                            {(s.capacite_totale_kwh || s.capacite_kwh || s.capacite_batterie_kwh) && <span className="flex items-center gap-1"><Battery className="w-3.5 h-3.5 text-emerald-500 fill-emerald-500" />{String(s.capacite_totale_kwh || s.capacite_kwh || s.capacite_batterie_kwh)} kWh</span>}
